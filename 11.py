...
for i in range(0 , 20) :
    for j in range(0 ,17) :
        count = n[i][j] * n[i][j+1] * n[i][j+2] * n[i][j+3]
        if big < count : 
            big = count
            loop = 1
            a = n[i][j]
...
for i in range(0 , 17) :
    for j in range(0 ,20) :
        count = n[i][j] * n[i+1][j] * n[i+2][j] * n[i+3][j]
        if big < count : 
            big = count
            loop = 2
            a = n[i][j]
...
for i in range(0 , 17) :
    for j in range(0 ,17) :
        count = n[i][j] * n[i+1][j+1] * n[i+2][j+2] * n[i+3][j+3]
        if big < count : 
            big = count
            loop = 3
            a = n[i][j]
...
print('the numbers making this result are : ')
print(a)
print(b)
print(c)
print(d)
print('from the loop' , loop)
